...
import com.ltf.util.BuildConfig;
...
public class HttpManager {
    ...
    private static OkHttpClient builder = new OkHttpClient.Builder()
            .cache(new Cache(new File(MyApplication.getMyApplication().getCacheDir(), "afeicache"), 1024 * 1024 * 100))
