...
public class HomeFragmentPresenter implements IHomeFragmentPresenter {
    ...
    @Override
    public void banner() {
        homeFragmentModel.banner(new IHomeFragmentBannerListener() {
            @Override
            public void netSeccess(List<HomeBanner.DataBean> beanList) {
                iHomeFragmentView.bannerSuccess(beanList);
            }

            @Override
            public void netFail(String message) {
                iHomeFragmentView.bannerFail(message);
            }
        });
    }
    ...
    @Override
    public void list() {
        homeFragmentModel.list(mPage, new IHomeFragmentListListener() {
            @Override
            public void netSeccess(HomeList.DataBean dataBean) {
                iHomeFragmentView.listSuccess(dataBean);
            }

            @Override
            public void netFail(String message) {
                iHomeFragmentView.listFail(message);
            }
        });
    }
